...
public class RepeatedAStarGreaterGTester {
	...
	public List<Node> callRepeatedAStarLargeG(Node[][] gridMap, Node startNode,
		...
		incrementalMap = repAStar.incrementalMap(incrementalMap, gridMap,
				startNode);
		/*
		 * incrementalMap = repAStar.goalAwareMap(incrementalMap, gridMap,
		 * goalNode);
		 */
		...
		System.out.println("Repeapted Forward A* for large G tie breaker S("
